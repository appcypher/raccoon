mod unittest {
    use crate::{
        lexer::{BytesKind, IntegerKind, Keyword, StringKind, Token, TokenKind},
        span::Span,
    };

    use super::super::{LexerError, LexerErrorKind::*};
    ...
    fn can_tokenize_floats() {
        ...
        let result_leading_non_zero_digit_no_fraction_with_positive_exponent =
            get_tokens("1_23e+4_5");
        let result_leading_non_zero_digit_no_fraction_with_negative_exponent =
            get_tokens("12_3e-4_5");
...
mod proptests {
    ...
    // // TODO(appcypher):
    // #[proptest]
    // fn can_lex_valid_code(input: String) {
    //     todo!()
    // }
}
