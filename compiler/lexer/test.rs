...
fn can_tokenize_indentations() {
    ...
    let result_mixed_spaces = get_tokens("lorem\n \t ipsum");
    let result_mixed_indentation_spaces = get_tokens("lorem\n  ipsum\n\t\t\t\tdolor\nsit");
    let result_mixed_indentation_sizes = get_tokens("lorem\n  ipsum\n      dolor\nsit");
    let result_inconsistent_dedent = get_tokens("lorem\n  ipsum\n dolor");
    ...
    assert_eq!(
        ...
        vec![
            ...
            TokenResult::Ok(Token::new(
                TokenKind::Identifier("dolor".to_string()),
                Span::new(15, 20)
            )),
...
#[test]
fn can_tokenize_imaginary_numbers() {
    let result_leading_zero_single = get_tokens("0im");
    let result_leading_zero_with_fraction = get_tokens("00.123im");
    let result_leading_zero_with_fraction_and_exponent = get_tokens("00.123e-123im");
    let result_leading_zero_without_fraction_with_exponent = get_tokens("00e123im");

    let result_leading_non_zero_single = get_tokens("5im");
    let result_leading_non_zero_multiple = get_tokens("5_907im");
    let result_leading_non_zero_with_fraction = get_tokens("5_907.1_230im");
    let result_leading_non_zero_with_fraction_and_exponent = get_tokens("5_907.1_230e-1_230im");
    let result_leading_non_zero_without_fraction_with_exponent = get_tokens("5_907e1_230im");

    assert_eq!(
        result_leading_zero_single,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("0".into()),
            Span::new(0, 3)
        ))]
    );

    assert_eq!(
        result_leading_zero_with_fraction,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("0.123".into()),
            Span::new(0, 8)
        ))]
    );

    assert_eq!(
        result_leading_zero_with_fraction_and_exponent,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("0.123e-123".into()),
            Span::new(0, 13)
        ))]
    );

    assert_eq!(
        result_leading_zero_without_fraction_with_exponent,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("0e+123".into()),
            Span::new(0, 8)
        ))]
    );

    assert_eq!(
        result_leading_non_zero_single,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("5".into()),
            Span::new(0, 3)
        ))]
    );

    assert_eq!(
        result_leading_non_zero_multiple,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("5907".into()),
            Span::new(0, 7)
        ))]
    );

    assert_eq!(
        result_leading_non_zero_with_fraction,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("5907.1230".into()),
            Span::new(0, 13)
        ))]
    );

    assert_eq!(
        result_leading_non_zero_with_fraction_and_exponent,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("5907.1230e-1230".into()),
            Span::new(0, 20)
        ))]
    );

    assert_eq!(
        result_leading_non_zero_without_fraction_with_exponent,
        vec![TokenResult::Ok(Token::new(
            TokenKind::Imag("5907e+1230".into()),
            Span::new(0, 13)
        ))]
    );
}
...
fn can_tokenize_operators() {
    ...
    let result_incomplete_not_eq = get_tokens("!");

    assert_eq!(
        result_valid_operators,
        vec![
            TokenResult::Ok(Token::new(TokenKind::Op(Operator::Plus), Span::new(0, 1))),
...
fn can_tokenize_delimiters() {
    ...
    assert_eq!(
        result_valid_operators,
        vec![
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::LParen), Span::new(0, 1))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::RParen), Span::new(2, 3))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::LBracket), Span::new(4, 5))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::RBracket), Span::new(6, 7))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::LBrace), Span::new(8, 9))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::RBrace), Span::new(10, 11))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::Comma), Span::new(12, 13))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::Colon), Span::new(14, 15))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::Dot), Span::new(16, 17))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::SemiColon), Span::new(18, 19))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::At), Span::new(20, 21))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::Assign), Span::new(22, 23))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::Arrow), Span::new(24, 26))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::PlusAssign), Span::new(27, 29))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::MinusAssign), Span::new(30, 32))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::MulAssign), Span::new(33, 35))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::DivAssign), Span::new(36, 38))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::IntDivAssign), Span::new(39, 42))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::ModAssign), Span::new(43, 45))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::AtAssign), Span::new(46, 48))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::BitAndAssign), Span::new(49, 51))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::BitOrAssign), Span::new(52, 54))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::BitXorAssign), Span::new(55, 57))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::ShiftRAssign), Span::new(58, 61))),
            TokenResult::Ok(Token::new(TokenKind::Delim(Delimiter::ShiftLAssign), Span::new(62, 65))),
        ]
    )
}
